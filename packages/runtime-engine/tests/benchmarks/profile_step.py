...
Run: .venv/bin/python packages/runtime-engine/tests/benchmarks/profile_step.py
"""
...
for src in (
    ROOT / "packages" / "runtime-api" / "src",
    ROOT / "packages" / "runtime-engine" / "src",
    ROOT / "packages" / "runtime-store" / "src",
    ROOT / "packages" / "runtime-boot" / "src",
):
