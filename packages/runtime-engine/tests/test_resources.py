    ...
    _write(
        ...
        "\n".join(
            [
                ...
                "  run: cap:x:run",
                "resolve:",
                "  default: cap:_test_host_resolve:resolve",
            ]
        ),
    )
    _write(
    ...
    _write(
        ...
        "\n".join(
            [
                ...
                "  run: cap:x:run",
                "resolve:",
                "  default: cap:_test_host_supports:resolve",
            ]
        ),
    )
    _write(
    ...
    _write(
        ...
        "\n".join(
            [
                ...
                "  run: cap:x:run",
                "resolve:",
                "  default: cap:_test_doc_host:resolve",
            ]
        ),
    )
    _write(
    ...
    _write(
        ...
        "\n".join(
            [
                ...
                "  run: cap:x:run",
                "resolve:",
                "  default: cap:_test_doc_variant_host:resolve",
            ]
        ),
    )
    _write(
